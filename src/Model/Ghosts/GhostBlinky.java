...
public class GhostBlinky extends EntitiesDynamic {
    public GhostBlinky() {
        this.locationY = 10;
        this.locationX = 14;
        setDefaultValues();
    ...
    public void getGhostImage() { // drawing the player in every position
        try {
            staring = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/1/0.png"));
            up1 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/1/U1.png"));
            up2 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/1/U2.png"));
            down1 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/1/D1.png"));
            down2 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/1/D2.png"));
            left1 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/1/L1.png"));
            left2 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/1/L2.png"));
            right1 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/1/R1.png"));
            right2 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/1/R2.png"));
