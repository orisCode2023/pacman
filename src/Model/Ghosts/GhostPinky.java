...
public class GhostPinky extends EntitiesDynamic {
    ...
    public void setDefaultValues() {
        startPoint();
        speed = 2;
        direction = Direction.STARING;
    }

    public void getGhostImage() { // drawing the player in every position
        try {
            staring = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/4/0.png"));
            up1 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/4/up1.png"));
            up2 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/4/up2.png"));
            down1 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/4/down1.png"));
            down2 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/4/down2.png"));
            left1 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/4/left1.png"));
            left2 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/4/left2.png"));
            right1 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/4/right1.png"));
            right2 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/4/right2.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void draw(Graphics2D g2) {
        ...
        switch (direction) {
            case STARING:
                image = spriteNumber == 1 ? staring : staring;
                break;
            case UP:
