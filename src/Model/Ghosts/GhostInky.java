...
public class GhostInky extends EntitiesDynamic {
    public GhostInky() {
        this.locationY = 10;
        this.locationX = 13;
        setDefaultValues();
    ...
    public void getGhostImage() { // drawing the player in every position
        try {
            staring = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/2/0.png"));
            up1 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/2/up1.png"));
            up2 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/2/up2.png"));
            down1 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/2/down1.png"));
            down2 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/2/down2.png"));
            left1 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/2/left1.png"));
            left2 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/2/left2.png"));
            right1 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/2/right1.png"));
            right2 = ImageIO.read(getClass().getResourceAsStream("/Resource/ghosts/2/right2.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public MapPacman[][] startPoint() {
        return new MapPacman[locationY][locationX];
    }
    void canMove() {
